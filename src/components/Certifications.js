...
const services=[
  
  {
    ...
    description: "Worked on AWS servers and learnt about creating Web Apps using AWS.",
    link:'https://drive.google.com/file/d/1NZJG1ZOBQ8jtcQnttOhXvWHi0vYWC-uw/view?usp=sharing',
  },
  {
    name : 'JavaScript WITH HTML AND CSS',
    description: "This covered how to build modern webpages using JavaScript and it's frameworks.",
  ...
  // },
  {
    ...
    description: "Learnt about fundamentals of IoT, history and origin of IoT and uses in our daily lif",
        ...
        className='flex-1'>
          ...
          <div>
            {services.map((service,index)=> {
              ...
              return(
              <div className='border-b border-white/20 h-[146px] mb-[38px] flex justify-center items-center' key={index}>
                ...
                <div className='flex flex-col flex-1 items-end'>
                  ...
                  <a className='text-gradient text-sm' href={link} target='_blank' rel="noreferrer">See Certificate</a>
                </div>
              </div>
              );
            })}
